 ...
 * processing values within range [0, 1].
 */
 ...
 * Note that this implementation returns the additive average of the
 * given values, returning NaN if no value is given.
 * @param the values as an argument list
 ...
 * Note that this implementation returns the multiplicative average of the
 * given values, returning NaN if no value is given.
 * @param the values as an argument list
